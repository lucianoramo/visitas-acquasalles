...
function Report() {
      return (
            <div id="report" className="container mx-auto">
                        ...
                        <div className="flex items-center justify-start border-y-4">
                              ...
                              <div className="w-1/3 text-xs">
                                    <ul>
                                          ...
                                          <li className="font-bold">
                                                Endereço:<span className="font-light">Enderço</span>
                                          </li>
                                    </ul>
                              </div>
                  ...
                  <section id="inspection-visit" className="mt-8">
